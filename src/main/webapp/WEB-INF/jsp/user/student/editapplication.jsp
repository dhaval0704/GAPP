...
<script type="text/javascript">
	$(document).ready(function() {
		...
		AddAdditionalFieldValuesByApplication();
	});
								...
								newTextBoxDiv
										...
										.html(
												'<label> '
														+ response[i]["additionalFieldName"]
														+ ' : </label>'
														+ '<input type="file" style="width:400px" class="form-control" name="textbox' + i + 
									      '" id="textbox' + i + '" value="" >');
		...
		<div style="width: 97%; margin-left: 25px;">
			...
			<div class="panel panel-primary">
				...
				<table cellspacing="5px" cellpadding="7px"
					...
					<tr>
						<td class="text-primary">TOEFL Score :</td>
					...
					<tr>
						...
						<td><input type="file" name="file" /><a
			...
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h3 class="panel-title">Additional Information ( For Extra Credit )</h3>
				</div>
